...
public final class LogMessages {
    ...
    public static final String USER_FIND_BY_DOCUMENT_ID_STARTED = "[CREDIYA-DB-{}] Starting to find user by document ID: {}";
    public static final String USER_FIND_BY_DOCUMENT_ID_SUCCESS = "[CREDIYA-DB-{}] User found in database by document ID: {}";
    public static final String USER_FIND_BY_DOCUMENT_ID_NOT_FOUND = "[CREDIYA-DB-{}] User not found in database by document ID: {}";
    public static final String USER_FIND_BY_DOCUMENT_ID_ERROR = "[CREDIYA-DB-{}] Error finding user by document ID in database";
